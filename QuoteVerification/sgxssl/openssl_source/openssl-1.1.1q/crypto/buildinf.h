...
#define DATE "built on: Fri Feb 10 23:28:07 2023 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','c','k',' ','-','W','a','l','l',' ','-','O','3',' ','-','i',
    'n','c','l','u','d','e','/','w','o','r','k','s','p','a','c','e',
    '/','S','G','X','D','a','t','a','C','e','n','t','e','r','A','t',
    't','e','s','t','a','t','i','o','n','P','r','i','m','i','t','i',
    'v','e','s','/','Q','u','o','t','e','V','e','r','i','f','i','c',
    'a','t','i','o','n','/','s','g','x','s','s','l','/','L','i','n',
    'u','x','/','.','.','/','o','p','e','n','s','s','l','_','s','o',
    'u','r','c','e','/','b','y','p','a','s','s','_','t','o','_','s',
    'g','x','s','s','l','.','h',' ','-','D','O','P','E','N','S','S',
    ...
    '-','D','N','D','E','B','U','G',' ','-','D','_','F','O','R','T',
    'I','F','Y','_','S','O','U','R','C','E','=','2',' ','-','D','G',
    'E','T','P','I','D','_','I','S','_','M','E','A','N','I','N','G',
    'L','E','S','S','\0'
};
